...
<main class="flex h-screen w-full flex-col items-center justify-center bg-gradient-to-t from-gray-900 via-gray-700 to-gray-900 text-white">
	...
	<div class="relative">
		...
		<!-- error url  -->
		<div
			class="absolute left-1/2 top-1/2 mx-auto -translate-x-1/2 -translate-y-1/2 rotate-12 transform whitespace-nowrap rounded-md bg-red-600/80 px-2 text-center text-sm font-bold text-white"
		>
